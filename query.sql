...
create table users (token int primary key ,firstname varchar (32),secondname varchar(32),username varchar(32) unique, usermail varchar(255) unique, userpass varchar (32) );
...
create table productorder (id int primary key,customername varchar(64),email varchar(255),phonenum varchar(20), city varchar(32), payment varchar (32) , address varchar(255) , total int , token int , category varchar(128) , size varchar(32), ordercode int , quantity int);
